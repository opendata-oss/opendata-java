...
import io.opendata.log.LogEntry;
import io.opendata.log.LogReader;
 ...
 * is available (see issue #130, item 3b).
 *
 * <p>Architecture:
 * <ul>
 ...
 * </ul>
 */
public class OpendataConsumer implements BenchmarkConsumer {
     ...
     */
    public OpendataConsumer(Log log, String topic, ConsumerCallback callback) {
     ...
     */
    public OpendataConsumer(Log log, String topic, int numPartitions, ConsumerCallback callback) {
     ...
     */
    public OpendataConsumer(Log log, String topic, int numPartitions,
