 ...
 * </ul>
 */
public class OpendataProducer implements BenchmarkProducer {
     ...
     */
    public OpendataProducer(Log log, String topic) {
        this(log, topic, 1);
    }
     ...
     */
    public OpendataProducer(Log log, String topic, int numPartitions) {
        this.log = log;
